...
var (
	...
	multipleIstioGatewaysConfig = &Config{
		Master:                      "http://127.0.0.1:8080",
		KubeConfig:                  "/some/path",
		RequestTimeout:              time.Second * 77,
...
func TestParseFlags(t *testing.T) {
	for _, ti := range []struct {
		...
		{
			title: "override everything via flags with multiple istio ingress gateway load balancer services",
			args: []string{
				"--master=http://127.0.0.1:8080",
				"--kubeconfig=/some/path",
				"--request-timeout=77s",
			...
			envVars:  map[string]string{},
			expected: multipleIstioGatewaysConfig,
		},
		{
