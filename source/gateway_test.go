...
func testEndpointsFromGatewayConfig(t *testing.T) {
	for _, ti := range []struct {
		...
		{
			title: "one rule.host two gateway hostnames",
			lbServices: []fakeIngressGatewayService{
				{
...
func testGatewayEndpoints(t *testing.T) {
	...
	for _, ti := range []struct {
		...
		{
			title:           "two simple ingress gateway services",
			targetNamespace: "",
			lbServices: []fakeIngressGatewayService{
				{
					ips:       []string{"8.8.8.8"},
		...
		{
			title:           "two simple ingress gateway services on different namespaces",
			targetNamespace: "",
			lbServices: []fakeIngressGatewayService{
				{
					ips:       []string{"8.8.8.8"},
		...
		{
			title:           "two simple ingress gateway services on different namespaces with target namespace",
